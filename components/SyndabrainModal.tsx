...
export default function SyndabrainModal({
  ...
  const params = new URLSearchParams({
    ...
    ...Object.fromEntries(Object.entries(pageContext).map(([k,v])=>[k,String(v)])),
  }).toString();
  const src = `${base}/widget?${params}`;
  ...
  return (
    <dialog ref={dialogRef} className="s-modal" onMouseDown={onBackdrop}>
