      ...
      <header className="sticky top-0 z-50 w-full bg-white/90 backdrop-blur border-b border-slate-200 dark:bg-[#0B0F19]/90 dark:border-slate-800">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 h-14 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            <Link href="/#what-we-do" className="hover:opacity-80">What we do</Link>
            <Link href="/#how-we-do-it" className="hover:opacity-80">How we do it</Link>
            <Link href="/#syndatools" className="hover:opacity-80">Syndatools</Link>
